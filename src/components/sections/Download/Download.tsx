...
const downloadTemplate = "./../../../assets/images/download-template.jpeg";
  ...
  return (
    ...
    <div className='downloaddiv' >
        ...
        {/* <p ><FormattedMessage id='Download.Title' /></p> */}
          ...
          <a className="app-btn blu flex vert" href="https://play.google.com/store/apps/details?id=in.iiit.cropdarpan">
            <i className="fab fa-google-play"></i>
            <p> <FormattedMessage id='Download.Text1' />  <br /> <span className="big-txt"><FormattedMessage id='Download.Option1' />
</span></p>
          </a>

          <a className="app-btn blu flex vert" href="https://apps.apple.com/us/app/crop-darpan/id1556486922">
